...
<ul>
<li><a href="#org69e0362">1. Introduction</a>
<ul>
<li><a href="#org2e4dc2b">1.1. Technologies</a></li>
<li><a href="#org3f3f177">1.2. Prerequisites</a></li>
<li><a href="#orgcddd007">1.3. Installation</a></li>
<li><a href="#org796d0a4">1.4. Verification</a></li>
</ul>
</li>
<li><a href="#orgd39fa4b">2. Usage</a>
<ul>
<li><a href="#orgecd65d0">2.1. General Usage</a>
<ul>
<li><a href="#org197fb00">2.1.1. Schedule CSV Format</a></li>
<li><a href="#org5810968">2.1.2. Factoids/Fun Facts CSV Format</a></li>
</ul>
</li>
<li><a href="#orgf537bbb">2.2. Technical Usage</a></li>
<li><a href="#org9f31ce6">2.3. Detailed Explanation</a></li>
</ul>
</li>
<li><a href="#org0fee820">3. Troubleshooting</a>
<ul>
<li><a href="#org38c918b">3.1. Nothing is showing up for the schedule or the fun facts!</a>
<ul>
<li><a href="#org5152776">3.1.1. You uploaded a malformed CSV.</a></li>
<li><a href="#org42e5f32">3.1.2. You uploaded the wrong CSV to the wrong component.</a></li>
<li><a href="#org60006a1">3.1.3. You uploaded a properly-formatted CSV too early.</a></li>
</ul>
</li>
<li><a href="#orga661a88">3.2. Twitter isn't updating!</a></li>
</ul>
</li>
<li><a href="#org23f46d5">4. Improvements</a>
<ul>
<li><a href="#org526f27a">4.1. Missteps and Compromises</a>
<ul>
<li><a href="#org94d4101">4.1.1. Administrative endpoint is brutalistic at best</a></li>
<li><a href="#orgd86db84">4.1.2. No proper configuration file</a></li>
<li><a href="#org6962860">4.1.3. Environment variables and keys exposed to public</a></li>
<li><a href="#org952003a">4.1.4. Files are not automatically renamed</a></li>
<li><a href="#org0e1948b">4.1.5. Magic numbers</a></li>
<li><a href="#org0dccf04">4.1.6. Misnamed variables</a></li>
<li><a href="#orgd0910b8">4.1.7. advanceDate()/advanceDay()/nextDay() does not advance application's date</a></li>
</ul>
</li>
<li><a href="#orgc34292c">4.2. Simple/Low</a>
<ul>
<li><a href="#org723374d">4.2.1. Add style to the administrative endpoint.</a></li>
<li><a href="#orgc31e6e5">4.2.2. Write to a single file per component.</a></li>
</ul>
</li>
<li><a href="#org26a72c7">4.3. Intermediate/Moderate</a>
<ul>
<li><a href="#org5285c30">4.3.1. Extract variables and create configuration file.</a></li>
<li><a href="#org38637d0">4.3.2. Move magic numbers into configuration file.</a></li>
<li><a href="#org7fada12">4.3.3. Rename the misleading variables and functions.</a></li>
</ul>
</li>
<li><a href="#orgf4610c5">4.4. Intricate/High</a>
<ul>
<li><a href="#org0b6e356">4.4.1. Advance the application's date automatically.</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgbdd862d">5. Closing Notes</a></li>
</ul>
</div>
</div>
...
**The fix:** Please ensure that you followed the correct format [as seen above](#orgb662558).
...
# Improvements<a id="org19a6843"></a><sup><a id="fnr.2" class="footref" href="#fn.2">2</a></sup>
...
IIRC, these functions change specific variables related to the date but not the date the application needs to recalculate the longform days ("Today", "Tomorrow", <DAY OF THE WEEK>). As a result, the server is [restarted every night at midnight](#org40589ef) to recalculate those days.
